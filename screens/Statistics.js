...
export default function App() {
  ...
  function GameDataDisplay({
    ...
    const trimActionName = (action, category) => {
      if (category === "T/O") {
        // Handle Turnovers specifically since the category is abbreviated;lm;lm;l soon
    ...
    // Helper function to render a sectionnnsvsnnn;lj;l soon this will all makes sense
